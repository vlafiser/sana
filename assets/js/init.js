...
document.addEventListener("DOMContentLoaded", function(event) { 
	...
	featureImage.id  = "featureImage-moved";
	document.getElementById("newPos-featureImage").appendChild(featureImage);

	var featureImage = document.getElementById("featureImage2");
	featureImage.id  = "featureImage-moved2";
	document.getElementById("newPos-featureImage2").appendChild(featureImage);
	...
	// var playButton = document.getElementById('play-button');
	// if(playButton){
	//   playButton.addEventListener('click', swapper, false);
	// }
...
// 	slider.find('.control').find('li').click(function() {
// 		clearInterval(sliderTimer);

// 		currentSlideClass = $(this).attr('class');
// 		var withoutActiveClass = currentSlideClass.replace(' active','');
// 		currentSlide = withoutActiveClass.replace('slide-','');

// 		$(this).parents(sliderId).attr('class', 'slide-' + currentSlide);
// 		$(this).parents(sliderId).find('.control, .content').find('.active').removeClass('active');
// 		$(this).addClass('active');
// 		$(this).parents(sliderId).find('.content').find('.slide-' + currentSlide).addClass('active');
// 	});


//    	slider.swipe( {
//         swipeLeft:function(event, direction, distance, duration, fingerCount) {
//      		sliderSwipeClassHandler(direction);
//         },
...
// 	function sliderSwipeClassHandler(direction){
// 		clearInterval(sliderTimer);

// 		currentSlideClass = slider.attr('class');
// 		currentSlide = parseInt(currentSlideClass.replace('slide-',''));
...
// 		function classHandlers(){
// 			slider.attr('class', 'slide-' + currentSlide);
// 	    	slider.find('.control, .content').find('.active').removeClass('active');
// 	    	slider.find('.control, .content').find('.slide-' + currentSlide).addClass('active');
// 		}
...
//     	sliderSwipeClassHandler("left");
//     }, 6000);


// 	$("#integrations-visual").find('.button').click(function() {
// 		var feature = $(this).parents('.feature');
// 		var runner  = $(this).parent();

// 		if (feature.hasClass('animate')) {
// 			feature.removeClass('animate');
// 		}
...
// 			var wrap = runner.parent();
			
// 			wrap.find('.runner--2').removeClass('runner--2').addClass('runner--3');
// 			wrap.find('.runner--1').removeClass('runner--1').addClass('runner--2');
// 	        runner.addClass('runner--1');
// 	        runner.removeClass('runner--3 active');
// 	    }, 400);
// 	});


// 	$('#feature-connector').waypoint(function(direction) {
// 	  $('#feature-connector').addClass('animate');
// 	}, {
// 	  offset: '40%'
// 	})


// 	$('#feature-integrations').waypoint(function(direction) {
// 	  $('#feature-integrations').addClass('animate');
// 	}, {
// 	  offset: '40%'
// 	})
// };
